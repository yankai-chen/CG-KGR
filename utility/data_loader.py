...
def load_adj(adj_u2i_name, adj_i2u_name, adj_i2e_name, adj_relation_name):
    adj_u2i_file = open(adj_u2i_name, 'rb')
    adj_u2i = pickle.load(adj_u2i_file)

    adj_i2u_file = open(adj_i2u_name, 'rb')
    adj_i2u = pickle.load(adj_i2u_file)

    adj_i2e_file = open(adj_i2e_name, 'rb')
    adj_i2e = pickle.load(adj_i2e_file)

    adj_relation_file = open(adj_relation_name, 'rb')
    adj_relation = pickle.load(adj_relation_file)

    return adj_u2i, adj_i2u, adj_i2e, adj_relation
